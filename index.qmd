...
Map of Regional Fishery Science Center Labs. Regions are designated by color (see legend) with each region's primary lab indicated by color-coded text. For NEFSC labs: **WH** = Woods Hole, **NA** = Narragansett, **MI** = Milford, **SH** = Sandy Hook. 
![](/content/code/output/Mainland.4.png){width=90%}![](/content/code/output/Legend.png){width=10%}
![](/content/code/output/Alaska.png){width=54%}![](/content/code/output/Hawaii.2.png){width=46%}
