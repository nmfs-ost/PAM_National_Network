...
![](/content/images/Priority_project_graphics/Stock_assessments/SLOCUM-GLIDER.png){width=40%}

### Team Leads
Erin Oleson (PIFSC), Yvonne Barkley (PIFSC)

### Goal
Advance the accuracy of stock assessments to capture seasonal and long-term changes using glider PAM datasets.
